...
class AuthPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final model = ref.watch(loginPageNotifierProvider);


    ref.listen<AuthState>(loginPageNotifierProvider, (prev, next) {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ref.read(loginPageNotifierProvider.notifier).login();
              },
